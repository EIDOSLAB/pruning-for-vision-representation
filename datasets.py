...
transform = pth_transforms.Compose(
    [
#         pth_transforms.PILToTensor(),
#         pth_transforms.v2.ToDtype(torch.float32, scale=True),
...
class Dataset:
    def __init__(self, dataset_name, dataset_set, remove_hards):
        ...
        if dataset_name == "VOC07":
            ...
            self.year = "2014"
            self.root_path = f"src/datasets/COCO/train/train2014"
            self.sel20k = 'src/datasets/COCO/train/coco_20K_filenames.txt'
            # JSON file constructed based on COCO train2014 gt 
            # self.all_annfile = "datasets/COCO/annotations/instances_train2014.json"
            self.all_annfile = "src/datasets/COCO/train/annotations/instances_train2014.json"
            self.annfile = "src/datasets/COCO/instances_train2014_sel20k.json"
...
def select_coco_20k(sel_file, all_annotations_file):
    ...
    with open("src/datasets/COCO/instances_train2014_sel20k.json", "w") as outfile:
